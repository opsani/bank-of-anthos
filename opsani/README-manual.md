# Manual Install of Bank of Anthos for Opsani Optimization

If you haven't already, please verify that the prerequisites in the [README.md](./README.md) document are met.
